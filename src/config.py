...
MESE_ANNUALI = 12
AUMENTO_CCNL_TOTALE_ANNUO = AUMENTO_CCNL_PER_PERSONA_PER_MESE * NUMERO_DIPENDENTI_INTERESSATI * MESE_ANNUALI
...
AMMORTAMENTO_IMMATERIALI_ANNUO = 200_000                # € (dato budget)
AMMORTAMENTO_MATERIALI_ANNUO = 796_875                  # € (dato budget)
